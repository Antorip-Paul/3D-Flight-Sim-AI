...
import {EARTH_RADIUS,groundHeight,groundPoint,ROCKET_BASE,terrainData} from './public/world.js';
...
assert(Math.abs(ROCKET_BASE+9+14*Math.cos(2.59))<1e-10,'Deployed leg tips touch the ground');
